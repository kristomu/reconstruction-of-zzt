...
typedef signed short smallint; // 16 bit
//typedef int longint; // 32 bit
//typedef smallint integer;   // So TP thinks at least
...
/* Note, $ED now redirects to U+03D5 as identified by IBM;
          ...
          smallint.*/
const array<0 , 255,smallint> cp437ToUnicode = {{
...
#ifdef __Unicode_implementation__
#undef EXTERN
#define EXTERN
#endif

EXTERN array<0 , 65536,char> UnicodeToCP437;
#undef EXTERN
