...
void pio_access_record(file_descriptor* fd, void* record,
                       size_t record_size);


void pio_store_record(file_descriptor* fd, void* record,
                      size_t record_size,
                      void* src);
...
void pio_write_record(file_descriptor* fd, void* record,
                      size_t record_size,
                      void* src);
...
int  pio_input_string(text_descriptor* td, char* buf, size_t len,
                      int padding);
...
public:
	...
	friend void BlockWrite(file& f, void const* buf, word size,
	                       word& written) {
